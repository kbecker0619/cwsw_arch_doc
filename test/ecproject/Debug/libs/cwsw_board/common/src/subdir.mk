...
C_SRCS += \
C:/_Projects/cwsw_evqueue_test/test/libs/cwsw_board/common/src/bd-di-buttons.c 

OBJS += \
./libs/cwsw_board/common/src/bd-di-buttons.o 

C_DEPS += \
./libs/cwsw_board/common/src/bd-di-buttons.d 


# Each subdirectory must supply rules for building sources it contributes
libs/cwsw_board/common/src/bd-di-buttons.o: C:/_Projects/cwsw_evqueue_test/test/libs/cwsw_board/common/src/bd-di-buttons.c
	@echo 'Building file: $<'
